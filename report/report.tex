...
The testing strategy employs automated testing for \textbf{Unit tests}

\subsection{Test Coverage}

The test coverage statistics can be found in the CodeCov page of the project \href{https://app.codecov.io/gh/luca-patrignani/mental-poker/tree/dev/v3}{here}.
